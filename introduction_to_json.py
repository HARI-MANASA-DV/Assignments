# -*- coding: utf-8 -*-
"""Introduction_to_JSON.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ynlySMRFGOYjJXwi2ZR5_TSDrPuoVy6B
...
p = json.loads(s)
print("Name:", p["name"])
print("Second Marks:", p["marks"][1])
print("City:", p["address"]["city"])

#Task 3
data = '{ "name": "Raj", "score": 88, "active": true }'
parsed_fixed = json.loads(data)
print(parsed_fixed)
